...
from app.schemas.garmin import GarminActivitiesPreviewResponse, GarminConnectRequest, GarminConnectResponse
from app.services.garmin import GarminRequestError, connect_garmin_account, list_garmin_activities
...
def preview_athlete_garmin_activities(
    ...
    try:
        activities = list_garmin_activities(db, athlete, start_date=start_date, end_date=end_date)
    except GarminRequestError as exc:
        raise HTTPException(status_code=exc.status_code, detail=str(exc)) from exc

...
WORKOUT_BLUEPRINTS: dict[tuple[str, str], dict[str, tuple[DraftSlot, ...]]] = {
    ("running", "aerobic_capacity_block"): {
        "load": (DraftSlot(1, "run_lt1_extensive"), DraftSlot(3, "run_economy_strides"), DraftSlot(6, "run_long_aerobic"), DraftSlot(2, "strength_general_support")),
        "build": (DraftSlot(2, "run_lt1_long_reps"), DraftSlot(4, "run_lt1_extensive"), DraftSlot(6, "run_long_aerobic"), DraftSlot(1, "strength_general_support")),
    ...
    ("ciclismo", "threshold_development_block"): {
        ...
        "build": (DraftSlot(2, "bike_over_under_threshold"), DraftSlot(5, "bike_aero_stability"), DraftSlot(6, "bike_fatmax_endurance")),
        "recovery": (DraftSlot(2, "bike_lt0_recovery"), DraftSlot(5, "bike_lt1_blocks"), DraftSlot(6, "test_profile_anchor")),
    },

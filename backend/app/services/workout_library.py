...
WORKOUT_TEMPLATES: tuple[WorkoutTemplate, ...] = (
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(7, "2×25'",    50, 3.0, "LT1", "medium", "Transición a bloques continuos.", 86),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(5, "105' E1",          105, 0.0, "BASE",  "medium", "Volumen alto sin cierre. Acumulación pura.",                total_duration_min=125),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(3, "6×800m",  24, 1.0, "LT2", "fresh", "Añade repeticiones; primer volumen útil real.", 59),
            DoseStep(4, "5×1km",   25, 1.25,"LT2", "fresh", "25' útiles a LT2; progresión en rep y volumen.", 62),
            DoseStep(5, "3×2km",   30, 1.5, "LT2", "fresh", "Más similar al tempo competitivo.", 67),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(4, "3×4km obj",     36, 2.0, "LT2",  "fresh",  "Repeticiones largas a ritmo de carrera.",           total_duration_min=75),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(3, "5×2km obj",    30, 1.5, "LT2",  "medium", "Mayor frecuencia. Más repeticiones, menor duración.",       total_duration_min=70),
            DoseStep(4, "4×3km obj",    36, 2.0, "LT2",  "fresh",  "Carga alta. 36' a ritmo objetivo.",                         total_duration_min=75),
            DoseStep(5, "2×5km obj",    30, 3.0, "LT2",  "fresh",  "Bloques largos. Máxima especificidad. Solo fase específica.", total_duration_min=70),
        ),
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(4, "2×20' prog",     40, 3.0, "LT2",   "medium", "Progresivo LT1→LT2. Alta especificidad de transición.",   total_duration_min=70),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(3, "4×6'",   24, 1.0, "SUB-T", "fresh", "Primera progresión de volumen SUB-T real.", 57),
            DoseStep(4, "3×10'",  30, 1.25,"SUB-T", "fresh", "Carga media; buen equilibrio densidad/calidad.", 62),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(3, "2×20'", 40, 5.0, "HM_pace", "fresh", "Bloques largos — exige umbral consolidado.", 75),
            DoseStep(4, "3×15'", 45, 4.0, "HM_pace", "fresh", "Progresión en duración y volumen.", 78),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(4, "2×25'",    50, 4.0, "LT1", "medium", "Transición a bloques continuos largos; buena especificidad LT1.", total_duration_min=85),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(5, "2×10×30''/30''",     10, 0.5, "VO2", "fresh",  "Formato intermitente. Alto TaVO2max. Solo atletas robustos.", total_duration_min=60),
        ),
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(3, "2×20' RP+15'T2",25, 0, "LT2",  "fresh",  "Bloques a ritmo de prueba + transición.",            total_duration_min=75),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "2h E1",      120, 0, "E1",  "any",    "Fondo base: introducción a volumen largo.",              total_duration_min=120),
            DoseStep(2, "2h30 E1",    150, 0, "E1",  "any",    "Fondo medio: consolidación de base aeróbica.",          total_duration_min=150),
            DoseStep(3, "3h Fatmax",  180, 0, "E1",  "any",    "Fondo largo estándar: adaptación cardiovascular.",      total_duration_min=180),
            DoseStep(4, "3h30 Fatmax",210, 0, "E1",  "medium", "Fondo largo extendido: durabilidad aeróbica.",          total_duration_min=210),
            DoseStep(5, "4h Fatmax",  240, 0, "E1",  "medium", "Fondo máximo: especificidad de larga distancia.",       total_duration_min=240),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(2, "2×15' O/U",  30, 5.0, "LT1-LT2", "fresh", "Bloques más largos; mayor tiempo en la zona de transición.", total_duration_min=65),
            DoseStep(3, "3×10' O/U",  30, 5.0, "LT1-LT2", "fresh", "Tres bloques; primer volumen real de over-under.", total_duration_min=70),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(4, "2×30' SUB-T",  60, 4.0, "SUB-T", "fresh", "Bloques continuos largos; alta especificidad.", total_duration_min=120),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(5, "2000m AEC frac.",     40, 0.25, "LT1", "medium", "Volumen alto fraccionado; reservar para atletas consolidados.", total_duration_min=63),
            DoseStep(6, "2500m AEC frac.",     50, 0.25, "LT1", "medium", "Carga máxima de base acuática; lectura de deriva.", total_duration_min=73),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(2, "6×150m CSS c/20''",  16, 0.33, "CSS", "fresh", "Repeticiones más largas; mejor especificidad metabólica.", total_duration_min=38),
            DoseStep(3, "10×100m CSS c/15''", 17, 0.25, "CSS", "fresh", "Más repeticiones; primer estímulo de umbral real.", total_duration_min=40),
            ...
            DoseStep(5, "4×300m CSS c/30''",  22, 0.5,  "CSS", "fresh", "Repeticiones largas; alta especificidad para distancias medias.", total_duration_min=46),
            DoseStep(6, "3×400m CSS c/45''",  23, 0.75, "CSS", "fresh", "Carga máxima; solo atletas con técnica estable y robustez alta.", total_duration_min=47),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(5, "2×600m race pace",  30, 3.0,  "RACE", "fresh",  "Series continuas: máxima especificidad.",        total_duration_min=60),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(3, "4×(4×100m) c/15''", 32, 0.25, "LT1", "any",    "Añade un bloque; primer volumen serio de base acuática.", total_duration_min=56),
            ...
            DoseStep(6, "6×300m LT1 c/25''", 48, 0.42, "LT1", "medium", "Series largas; máxima especificidad subumbral en piscina.", total_duration_min=72),
        ),
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(4, "8×75m VO2",    600,  0.7, "VO2", "fresh",  "Repeticiones más largas. Mayor densidad de VO2.",           total_duration_min=50),
            DoseStep(5, "10×100m VO2",  1000, 0.75,"VO2", "fresh",  "Carga máxima VO2. 1000m rápidos. Solo señal positiva.",     total_duration_min=55),
        ),
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        min_spacing_days_after=1,
        dose_ladder=(
            DoseStep(1, "2×400m OW",     16, 2.0, "RACE", "any",    "Introducción open water: sighting y orientación.",  total_duration_min=40),
            DoseStep(2, "3×400m OW",     24, 2.0, "RACE", "any",    "Más repeticiones con cambios de orientación.",      total_duration_min=50),
            ...
            DoseStep(5, "2×1000m OW",    40, 5.0, "RACE", "fresh",  "Bloques largos: máxima especificidad de prueba.",   total_duration_min=65),
        ),
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(3, "8×50m ANC",     8, 1.0,  "ANC", "fresh", "Repeticiones más largas: más tolerancia.",            total_duration_min=50),
            DoseStep(4, "2×(6×25m) ANC", 6, 0.67, "ANC", "fresh", "Bloques agrupados con macro-pausa entre sets.",      total_duration_min=50),
            DoseStep(5, "12×50m ANC",   12, 1.0,  "ANC", "fresh", "Dosis máxima: 600m. Solo élite con señal positiva.", total_duration_min=55),
        ),
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "4×20'' + 6×4' LT1",  25, 2.0, "AEC", "fresh", "Introducción mínima.", 55),
            DoseStep(2, "4×25'' + 7×4' LT1",  30, 2.0, "AEC", "fresh", "Volumen cola +1 rep.", 65),
            DoseStep(3, "5×25'' + 7×4' LT1",  30, 2.0, "AEC", "fresh", "+1 spice, cola igual.", 70),
            DoseStep(4, "5×30'' + 8×4' LT1",  35, 2.0, "AEC", "fresh", "Carga máxima AEC+spice.", 75),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "5×10'' + 5×7' LT1",  36, 2.0, "AEC", "fresh", "Intro conservadora.", 70),
            DoseStep(2, "5×10'' + 6×8' LT1",  49, 2.0, "AEC", "fresh", "Cola más larga.", 80),
            DoseStep(3, "6×10'' + 5×10' LT1", 51, 2.0, "AEC", "fresh", "Bloques LT1 más largos.", 90),
            DoseStep(4, "6×10'' + 6×10' LT1", 61, 2.0, "AEC", "fresh", "Carga máxima: máximo volumen LT1.", 100),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "12-10-8-6' LT1",   36, 1.5, "AEC", "normal", "Intro escalado corto.", 36),
            DoseStep(2, "15-12-10-8' LT1",  45, 1.5, "AEC", "normal", "Escalado estándar.", 45),
            DoseStep(3, "15-12-10-8-6' LT1",51, 1.5, "AEC", "normal", "Formato completo del CSV.", 51),
            DoseStep(4, "20-15-12-10' LT1", 57, 1.5, "AEC", "normal", "Variante larga.", 57),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "6×30'' SIT + 3×15' LT1", 48, 2.0, "AEP", "fresh", "Intro SIT.", 90),
            DoseStep(2, "7×30'' SIT + 3×15' LT1", 49, 2.0, "AEP", "fresh", "Progresión +1 SIT.", 100),
            DoseStep(3, "8×30'' SIT + 4×12' LT1", 52, 2.0, "AEP", "fresh", "Carga máxima del CSV.", 110),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "8' LT1 + 20×20''/15''", 15, 2.0, "AEP", "fresh", "Intro: relación 20/15.", 55),
            DoseStep(2, "8' LT1 + 18×30''/20''", 17, 2.0, "AEP", "fresh", "Progresión T:D 30/20.", 60),
            DoseStep(3, "8' LT1 + 16×40''/30''", 19, 2.0, "AEP", "fresh", "Carga máxima 40/30.", 65),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(5, "8×30'' ANC",    4, 1.5, "ANC",  "fresh", "Carga máxima. Solo con señal positiva y robustez alta.", total_duration_min=75),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(4, "12×10'' ANC", 2, 3.0, "ANC",  "fresh", "Carga alta; solo atletas robustos con señal positiva.", 90),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(3, "16×25m ANC",    8, 0.58, "ANC", "fresh", "Progresión estándar. 400m de trabajo real.",         total_duration_min=55),
            DoseStep(4, "3×(4×25m) ANC", 6, 0.75, "ANC", "fresh", "Bloques agrupados con macro-pausa. 300m.",          total_duration_min=55),
            DoseStep(5, "20×25m ANC",   10, 0.50, "ANC", "fresh", "Dosis máxima: 500m. Solo élite con señal positiva.", total_duration_min=60),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(5, "12×30'' MAX",   6, 0.25, "ANP", "fresh", "Dosis máxima ANP bici. Solo 1-2 semanas.",             total_duration_min=80),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(4, "8×50m MAX",     8, 0.17, "ANP", "fresh", "Reps largas: más tolerancia a la acidosis.",           total_duration_min=55),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "8×400m c/15''",  16, 0.25, "RACE", "fresh",  "Introducción AEP: 3.2km a ritmo objetivo.",          total_duration_min=55),
            DoseStep(2, "10×400m c/15''",  20, 0.25, "RACE", "fresh",  "Progresión en repeticiones. 4km a ritmo.",           total_duration_min=60),
            ...
            DoseStep(5, "5×1200m c/20''",  30, 0.33, "RACE", "fresh",  "Bloques largos: máxima especificidad AEP.",         total_duration_min=70),
        ),
    ),
    WorkoutTemplate(

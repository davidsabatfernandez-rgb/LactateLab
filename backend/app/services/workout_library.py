...
class DraftSlot:
    ...
    """Pool de templates alternativos para rotación semanal.
    El sistema rota entre template_id (primario) y los alternates
    según el week_index dentro del bloque y el historial del atleta."""
...
EVIDENCE_SOURCES: dict[str, EvidenceSource] = {
    ...
    "seiler_2013_tid": EvidenceSource(
        source_id="seiler_2013_tid",
        citation="Seiler S. What is best practice for training intensity and duration distribution in endurance athletes? Int J Sports Physiol Perform. 2010.",
        source_type="review",
        athlete_level="elite",
        url="https://pubmed.ncbi.nlm.nih.gov/20861519/",
        key_takeaway="Distribución polarizada (~80/5/15) en élite; umbral zone II limitada a <10% del tiempo total.",
    ),
    "stoggl_2014_polarized": EvidenceSource(
        source_id="stoggl_2014_polarized",
        citation="Stöggl TL, Sperlich B. Polarized training has greater impact on key endurance variables than threshold, high-intensity, or high-volume training. Front Physiol. 2014.",
        source_type="randomized_controlled_trial",
        athlete_level="trained",
        url="https://pubmed.ncbi.nlm.nih.gov/24550842/",
        key_takeaway="Polarizado supera a umbral/HIT/alto-volumen en VO2max, TTE y velocidad pico en 9 semanas con atletas entrenados.",
    ),
    "mujika_2010_taper": EvidenceSource(
        source_id="mujika_2010_taper",
        citation="Mujika I. Intense training: the key to optimal performance before and during the taper. Scand J Med Sci Sports. 2010.",
        source_type="review",
        athlete_level="elite",
        url="https://pubmed.ncbi.nlm.nih.gov/20840561/",
        key_takeaway="En taper: mantener intensidad, reducir volumen 41-60%, no reducir frecuencia. 8-14 días óptimos.",
    ),
    "tonnessen_2014_openers": EvidenceSource(
        source_id="tonnessen_2014_openers",
        citation="Tønnessen E et al. The effect of 40 weeks of predicted versus best daily training-Loss classification of training load data in elite and sub-elite swimmers. Int J Sports Physiol Perform. 2014.",
        source_type="observational_study",
        athlete_level="elite",
        url="https://pubmed.ncbi.nlm.nih.gov/24634831/",
        key_takeaway="Sesiones de activación pre-competición (openers) mantienen adaptaciones sin acumular fatiga residual.",
    ),
    "seiler_2006_tid": EvidenceSource(
        source_id="seiler_2006_tid",
        citation="Seiler S, Kjerland GØ. Quantifying training intensity distribution in elite endurance athletes: is there evidence for an 'optimal' distribution? Scand J Med Sci Sports. 2006.",
        source_type="observational_study",
        athlete_level="elite",
        url="https://pubmed.ncbi.nlm.nih.gov/16430681/",
        key_takeaway="Los atletas de élite convergen en ~75/5/20 (Z1/Z2/Z3), confirmando predominancia de baja intensidad.",
    ),
    "gibala_2012_sprint": EvidenceSource(
        source_id="gibala_2012_sprint",
        citation="Gibala MJ et al. Physiological adaptations to low-volume, high-intensity interval training in health and disease. J Physiol. 2012.",
        source_type="review",
        athlete_level="general",
        url="https://pubmed.ncbi.nlm.nih.gov/22289907/",
        key_takeaway="SIT (sprint interval training) produce adaptaciones aeróbicas comparables a entrenamiento continuo con un 90% menos de volumen.",
    ),
}
...
WORKOUT_TEMPLATES: tuple[WorkoutTemplate, ...] = (
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(2, "3×10'",    30, 1.5, "LT1", "any",    "Repeticiones más largas; misma densidad.", 63),
            DoseStep(3, "4×8'",     32, 1.5, "LT1", "any",    "Primera progresión de volumen.", 67),
            DoseStep(4, "3×12'",    36, 1.5, "LT1", "medium", "Aumenta duración de repetición.", 70),
            DoseStep(5, "4×10'",    40, 1.5, "LT1", "medium", "Primer peldaño de carga media; 40' útiles.", 75),
            DoseStep(6, "4×12'",    48, 1.5, "LT1", "medium", "Carga alta de intervalos LT1.", 84),
            DoseStep(7, "2×25'",    50, 1.5, "LT1", "medium", "Transición a bloques continuos.", 86),
            DoseStep(8, "55' cont", 55, 0.0, "LT1", "medium", "Continuo: máxima especificidad LT1.", 87),
        ),
    ),
    WorkoutTemplate(
        ...
        enfriamiento_template="10' trote muy suave.",
        dose_ladder=(
            DoseStep(1, "60' E1",           60, 0.0, "BASE",  "any",    "Introducción conservadora. Solo acumular tiempo.",          total_duration_min=80),
            DoseStep(2, "75' E1",           75, 0.0, "BASE",  "any",    "Progresión de volumen. Vigilar deriva cardiaca.",           total_duration_min=95),
            DoseStep(3, "90' E1",           90, 0.0, "BASE",  "any",    "Duración estándar para tirada aeróbica.",                   total_duration_min=110),
            DoseStep(4, "90'+20' ctrl",     110, 0.0, "LT1",  "medium", "Cierre controlado 20' sub-LT1. Primera durabilidad real.",  total_duration_min=130),
            DoseStep(5, "105' E1",          105, 0.0, "BASE",  "medium", "Volumen alto sin cierre. Acumulación pura.",                total_duration_min=135),
            DoseStep(6, "120' aeróbicos",   120, 0.0, "BASE",  "medium", "Carga máxima de tirada larga. Solo atletas robustos.",      total_duration_min=140),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "4×800m",  16, 1.25, "LT2", "fresh", "Introducción; volumen bajo y lectura limpia del ritmo.", 49),
            DoseStep(2, "4×1km",   20, 1.25,"LT2", "fresh", "Repeticiones más largas; mejor especificidad.", 54),
            DoseStep(3, "6×800m",  24, 1.25, "LT2", "fresh", "Añade repeticiones; primer volumen útil real.", 59),
            DoseStep(4, "5×1km",   25, 1.25,"LT2", "fresh", "25' útiles a LT2; progresión en rep y volumen.", 62),
            DoseStep(5, "3×2km",   30, 1.25, "LT2", "fresh", "Más similar al tempo competitivo.", 67),
            DoseStep(6, "4×2km",   40, 1.25, "LT2", "fresh", "Carga alta; solo con robustez alta y señal positiva.", 76),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "4×3'",  12, 4.0, "VO2", "fresh", "Introducción; volumen bajo para asentar tolerancia al ritmo alto.", 51),
            DoseStep(2, "5×3'",  15, 4.0, "VO2", "fresh", "Añade una repetición; primer estímulo VO2 real.", 57),
            DoseStep(3, "4×4'",  16, 4.0, "VO2", "fresh", "Repeticiones más largas; mayor tiempo en VO2.", 58),
            DoseStep(4, "6×3'",  18, 4.0, "VO2", "fresh", "Seis repeticiones; coste alto pero controlable.", 63),
    ...
    WorkoutTemplate(
        ...
        requires_fresh=True,
        dose_ladder=(
            DoseStep(1, "60'+15' obj",   15, 0,   "LT2",  "medium", "Rodaje con 15' final a ritmo objetivo.",            total_duration_min=60),
            DoseStep(2, "70'+20' obj",   20, 0,   "LT2",  "medium", "Incremento gradual del tiempo a ritmo objetivo.",   total_duration_min=70),
            DoseStep(3, "80'+25' obj",   25, 0,   "LT2",  "medium", "25' a ritmo objetivo con fatiga previa.",           total_duration_min=80),
            DoseStep(4, "3×4km obj",     36, 2.0, "LT2",  "fresh",  "Repeticiones largas a ritmo de carrera.",           total_duration_min=85),
            DoseStep(5, "90'+30' obj",   30, 0,   "LT2",  "fresh",  "Bloque largo de especificidad tras 60' de base.",  total_duration_min=90),
        ),
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "40' prog",   40, 0.0, "BASE", "any",    "Progresivo suave 40'. Solo control de ritmo.",                total_duration_min=55),
            DoseStep(2, "50' prog",   50, 0.0, "BASE", "any",    "Progresivo E1→E2. Último tercio ligeramente más vivo.",       total_duration_min=65),
            DoseStep(3, "60' prog",   60, 0.0, "LT1",  "any",    "Progresivo controlado. Final en zona aeróbica alta.",         total_duration_min=75),
            DoseStep(4, "75' prog",   75, 0.0, "LT1",  "medium", "Progresivo largo. Cierre en E2/LT1 sin forzar.",              total_duration_min=90),
            DoseStep(5, "90' prog",   90, 0.0, "LT1",  "medium", "Carga máxima progresiva. Solo con buena respuesta previa.",   total_duration_min=105),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(3, "25' cont",  25, 0.0, "LT2", "fresh", "Extensión del continuo; pequeño progreso real.", 53),
            DoseStep(4, "30' cont",  30, 0.0, "LT2", "fresh", "30' sostenidos; referencia clásica de umbral.", 58),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "3×2km obj",    18, 2.0, "LT2",  "medium", "Introducción a ritmo objetivo. Volumen contenido.",          total_duration_min=55),
            DoseStep(2, "3×3km obj",    27, 2.0, "LT2",  "medium", "Progresión. 27' a ritmo objetivo con buena recuperación.",   total_duration_min=65),
            DoseStep(3, "5×2km obj",    30, 2.0, "LT2",  "medium", "Mayor frecuencia. Más repeticiones, menor duración.",       total_duration_min=70),
            DoseStep(4, "4×3km obj",    36, 2.0, "LT2",  "fresh",  "Carga alta. 36' a ritmo objetivo.",                         total_duration_min=75),
            DoseStep(5, "2×5km obj",    30, 2.0, "LT2",  "fresh",  "Bloques largos. Máxima especificidad. Solo fase específica.", total_duration_min=80),
        ),
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "3×(3'+3')",      18, 2.0, "SUB-T", "any",    "Introducción mixta. 3 bloques cortos LT1+LT2.",           total_duration_min=50),
            DoseStep(2, "4×(4'+4')",      32, 2.0, "SUB-T", "any",    "Progresión volumen. 32' útiles LT1/LT2 alternados.",      total_duration_min=65),
            DoseStep(3, "3×(8'+5')",      39, 2.0, "SUB-T", "medium", "Bloques largos. Mayor densidad de LT1.",                  total_duration_min=70),
            DoseStep(4, "2×20' prog",     40, 2.0, "LT2",   "medium", "Progresivo LT1→LT2. Alta especificidad de transición.",   total_duration_min=70),
            DoseStep(5, "3×(10'+5')",     45, 2.0, "SUB-T", "fresh",  "Carga alta mixta. 45' útiles. Solo con señal positiva.",  total_duration_min=80),
        ),
    ),
    WorkoutTemplate(
        ...
        requires_fresh=True,
        calentamiento_min=20,
        calentamiento_template="15' trote progresivo + 4×100m aceleraciones con 1' andando.",
        enfriamiento_min=10,
        enfriamiento_template="10' trote muy suave sub-LT1.",
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(5, "2×(6×3')", 36, 1.0, "LT2", "fresh", "Doble bloque; pausa de 2' entre bloques.", 78),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "3×(3'LT1+3'LT2)",         18, 1.5, "SUB-T",  "fresh", "Introducción sin sección LT2b.", 51),
            DoseStep(2, "4×(3'LT1+3'LT2)",         24, 1.5, "SUB-T",  "fresh", "Primer volumen útil del formato.", 59),
            DoseStep(3, "4×(3'LT1+3'LT2+2'LT2b)",  32, 1.5, "SUB-T", "fresh", "Añade la sección de remate — carga real.", 67),
            DoseStep(4, "5×(3'LT1+3'LT2+2'LT2b)",  40, 1.5, "SUB-T", "fresh", "Carga máxima del formato; reservar para bloque respondido.", 76),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "3×2km",  30, 3.0, "LT1", "any",    "Introducción; repeticiones cortas con margen.", 62),
            DoseStep(2, "4×2km",  40, 3.0, "LT1", "medium", "Carga media; primer volumen real de LT1 largo.", 75),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "3×6'",   18, 1.5, "SUB-T", "fresh", "Introducción; volumen bajo y ritmo calibrado.", 50),
            DoseStep(2, "2×10'",  20, 1.5, "SUB-T", "fresh", "Repeticiones más largas; mejor señal de umbral.", 52),
            DoseStep(3, "4×6'",   24, 1.5, "SUB-T", "fresh", "Primera progresión de volumen SUB-T real.", 57),
            DoseStep(4, "3×10'",  30, 1.5,"SUB-T", "fresh", "Carga media; buen equilibrio densidad/calidad.", 62),
            DoseStep(5, "3×12'",  36, 1.5, "SUB-T", "fresh", "Bloques largos; más especificidad competitiva.", 69),
            DoseStep(6, "4×10'",  40, 1.5, "SUB-T", "fresh", "Carga alta; solo con robustez alta y señal positiva.", 75),
        ),
    ),
    WorkoutTemplate(
        ...
        enfriamiento_min=10,
        enfriamiento_template="10' trote muy suave sub-LT1. Bishop 2003: mínimo 10' post-VO2.",
        coach_tips=(
        ...
        dose_ladder=(
            DoseStep(1, "8'uLT1+2×6×40''+8'uLT1",  40, 0.33, "VO2", "fresh", "Introducción; VO2 contenido.", 68),
            DoseStep(2, "8'uLT1+2×8×40''+8'uLT1",  44, 0.33, "VO2", "fresh", "Primer estímulo real del formato.", 72),
            DoseStep(3, "8'uLT1+2×10×40''+8'uLT1", 47, 0.33, "VO2", "fresh", "Carga alta; solo con robustez alta.", 77),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        requires_fresh=True,
        calentamiento_min=15,
        calentamiento_template="15' trote progresivo + movilidad dinámica.",
        enfriamiento_min=10,
        enfriamiento_template="10' trote suave sub-LT1.",
        dose_ladder=(
            DoseStep(1, "3×10'", 30, 4.0, "RACE", "fresh", "Introducción al formato.", 55),
            DoseStep(2, "3×12'", 36, 4.0, "RACE", "fresh", "Primer estímulo real — patrón CSV Nacho.", 62),
            DoseStep(3, "2×20'", 40, 4.0, "RACE", "fresh", "Bloques largos — exige umbral consolidado.", 75),
            DoseStep(4, "3×15'", 45, 4.0, "RACE", "fresh", "Progresión en duración y volumen.", 78),
            DoseStep(5, "2×25'", 50, 4.0, "RACE", "fresh", "Dosis máxima. Solo con robustez alta.", 82),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(4, "2×25'",    50, 2.0, "LT1", "medium", "Transición a bloques continuos largos; buena especificidad LT1.", total_duration_min=85),
            DoseStep(5, "55' cont", 55, 0.0, "LT1", "medium", "Continuo largo: alta especificidad subumbral en bici.", total_duration_min=85),
            DoseStep(6, "4×15'",    60, 2.0, "LT1", "medium", "60 minutos útiles; carga alta de bloques LT1 en bici.", total_duration_min=95),
            DoseStep(7, "70' cont", 70, 0.0, "LT1", "medium", "Carga máxima continua LT1; solo atletas robustos con respuesta positiva.", total_duration_min=100),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "2h E1",     120, 0.0, "BASE", "any",    "Salida corta. Acumulación de tiempo sin estrés.",             total_duration_min=150),
            DoseStep(2, "2h30 E1",   150, 0.0, "BASE", "any",    "Volumen medio. Buen balance fatiga/adaptación.",              total_duration_min=180),
            DoseStep(3, "3h E1",     180, 0.0, "BASE", "medium", "Duración estándar larga. Practicar fueling.",                 total_duration_min=210),
            DoseStep(4, "3h15 E1",   195, 0.0, "BASE", "medium", "Progresión de volumen sin final específico.",                 total_duration_min=225),
            DoseStep(5, "3h+30'ctrl",210, 0.0, "LT1",  "medium", "Salida larga con cierre controlado 30' LT1.",                total_duration_min=240),
            DoseStep(6, "4h fondo",  240, 0.0, "BASE", "fresh",  "Carga máxima. Solo con buena recuperación previa.",           total_duration_min=270),
        ),
    ),
    WorkoutTemplate(
        ...
        requires_fresh=True,
        dose_ladder=(
            DoseStep(1, "2×12'",    24, 4.0, "LT2", "fresh", "Introducción; dos bloques comparables con margen de lectura interno.", total_duration_min=62),
            DoseStep(2, "3×12'",    36, 4.0, "LT2", "fresh", "Añade un bloque; primer volumen real de umbral en bici.", total_duration_min=76),
            DoseStep(3, "2×20'",    40, 4.0, "LT2", "fresh", "Bloques más largos; referencia clásica 2×20' de FTP.", total_duration_min=78),
            DoseStep(4, "3×15'",    45, 4.0, "LT2", "fresh", "Más repeticiones de duración media; buen equilibrio densidad/calidad.", total_duration_min=85),
            DoseStep(5, "2×25'",    50, 4.0, "LT2", "fresh", "Bloques largos; alta especificidad de umbral sostenido.", total_duration_min=88),
    ...
    WorkoutTemplate(
        ...
        requires_fresh=True,
        dose_ladder=(
            DoseStep(1, "4×3' VO2",           12, 3.0, "VO2", "fresh",  "Introducción VO2. Volumen corto, máxima calidad.",          total_duration_min=50),
            DoseStep(2, "5×3' VO2",           15, 3.0, "VO2", "fresh",  "Progresión +1 rep. 15' útiles de VO2.",                    total_duration_min=55),
            DoseStep(3, "5×4' VO2",           20, 3.0, "VO2", "fresh",  "Repeticiones más largas. Referencia Rønnestad 2016.",      total_duration_min=60),
            DoseStep(4, "6×4' VO2",           24, 3.0, "VO2", "fresh",  "Carga alta VO2. 24' útiles.",                              total_duration_min=65),
            DoseStep(5, "2×10×30''/30''",     10, 3.0, "VO2", "fresh",  "Formato intermitente. Alto TaVO2max. Solo atletas robustos.", total_duration_min=70),
        ),
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        requires_fresh=True,
        dose_ladder=(
            DoseStep(1, "45'+15' T2",    15, 0, "LT2",  "medium", "Brick corto: introducción a transición.",             total_duration_min=60),
            DoseStep(2, "60'+20' T2",    20, 0, "LT2",  "medium", "Brick estándar: 1h bici + carrera controlada.",       total_duration_min=80),
            DoseStep(3, "2×20' RP+15'T2",25, 0, "LT2",  "fresh",  "Bloques a ritmo de prueba + transición.",            total_duration_min=85),
            DoseStep(4, "75'+25' T2",    25, 0, "LT2",  "fresh",  "Brick largo: más especificidad competitiva.",         total_duration_min=100),
            DoseStep(5, "90'+30' T2",    30, 0, "LT2",  "fresh",  "Brick máximo: ensayo parcial de competición.",        total_duration_min=120),
        ),
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "2h E1",      120, 0, "REC",  "any",    "Fondo base: introducción a volumen largo.",              total_duration_min=120),
            DoseStep(2, "2h30 E1",    150, 0, "REC",  "any",    "Fondo medio: consolidación de base aeróbica.",          total_duration_min=150),
            DoseStep(3, "3h Fatmax",  180, 0, "REC",  "any",    "Fondo largo estándar: adaptación cardiovascular.",      total_duration_min=180),
            DoseStep(4, "3h30 Fatmax",210, 0, "REC",  "medium", "Fondo largo extendido: durabilidad aeróbica.",          total_duration_min=210),
            DoseStep(5, "4h Fatmax",  240, 0, "REC",  "medium", "Fondo máximo: especificidad de larga distancia.",       total_duration_min=240),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "20'E1+3×6'LT1+20'E1", 78, 4.0, "LT1", "any",    "Introducción al formato.", 90),
            DoseStep(2, "20'E1+3×8'LT1+20'E1", 84, 4.0, "LT1", "any",    "Patrón base Nacho.", 100),
            DoseStep(3, "20'E1+4×8'LT1+20'E1", 92, 4.0, "LT1", "any",    "Bloque extra: más estímulo.", 110),
            DoseStep(4, "30'E1+3×10'LT1+30'E1", 110, 4.0, "LT1", "medium", "Versión larga con bloques mayores.", 130),
            DoseStep(5, "30'E1+4×10'LT1+30'E1", 120, 4.0, "LT1", "medium", "Dosis máxima — 2h30+ total.", 150),
        ),
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        requires_fresh=True,
        dose_ladder=(
            DoseStep(1, "2×10' O/U",  20, 5.0, "SUB-T", "fresh", "Introducción; dos bloques con alternancia LT1 alto / LT2 controlado.", total_duration_min=55),
            DoseStep(2, "2×15' O/U",  30, 5.0, "SUB-T", "fresh", "Bloques más largos; mayor tiempo en la zona de transición.", total_duration_min=65),
            DoseStep(3, "3×10' O/U",  30, 5.0, "SUB-T", "fresh", "Tres bloques; primer volumen real de over-under.", total_duration_min=70),
            DoseStep(4, "3×12' O/U",  36, 5.0, "SUB-T", "fresh", "Densidad media-alta; buen estímulo de tolerancia al cambio.", total_duration_min=74),
            DoseStep(5, "2×20' O/U",  40, 5.0, "SUB-T", "fresh", "Carga alta; reservar para atletas robustos con señal positiva.", total_duration_min=75),
        ),
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "4×6' LT1→LT2", 24, 3.0, "SUB-T", "fresh", "Introducción al formato.", 85),
            DoseStep(2, "5×6' LT1→LT2", 30, 3.0, "SUB-T", "fresh", "Primer volumen real del formato.", 95),
            DoseStep(3, "6×6' LT1→LT2", 36, 3.0, "SUB-T", "fresh", "Carga alta; solo con robustez alta.", 105),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "10×10''CadMax+3×9'LT1",  27, 2.0, "VO2", "any",    "Introducción; volumen LT1 contenido.", 90),
            DoseStep(2, "12×10''CadMax+4×9'LT1",  36, 2.0, "VO2", "any",    "Primer volumen real del combo.", 100),
            DoseStep(3, "15×10''CadMax+5×9'LT1",  45, 2.0, "VO2", "any",    "Clásico de Nacho; buen equilibrio.", 110),
            DoseStep(4, "15×10''CadMax+5×12'LT1", 60, 2.0, "VO2", "medium", "Carga alta; LT1 más largo.", 120),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "4×10' SUB-T",  40, 3.0, "SUB-T", "fresh", "Introducción; bloques cortos con lectura limpia.", total_duration_min=90),
            DoseStep(2, "3×20' SUB-T",  60, 3.0, "SUB-T", "fresh", "Bloques más largos; mejor especificidad.", total_duration_min=110),
            DoseStep(3, "4×15' SUB-T",  60, 3.0, "SUB-T", "fresh", "Más repeticiones; primer volumen real SUB-T.", total_duration_min=110),
            DoseStep(4, "2×30' SUB-T",  60, 3.0, "SUB-T", "fresh", "Bloques continuos largos; alta especificidad.", total_duration_min=120),
            DoseStep(5, "4×20' SUB-T",  80, 3.0, "SUB-T", "fresh", "Carga máxima; solo con robustez alta y señal positiva.", total_duration_min=130),
        ),
    ),
    WorkoutTemplate(
        ...
        requires_fresh=True,
        dose_ladder=(
            DoseStep(1, "6×50 técnica",  12, 0.5, "BASE", "any", "Intro técnica: 600m de drills y corrección.",      total_duration_min=35),
            DoseStep(2, "8×50 técnica",  16, 0.5, "BASE", "any", "Progresión: más metros de corrección técnica.",    total_duration_min=40),
            DoseStep(3, "8×50+6×100",    22, 0.5, "BASE", "any", "Técnica + nado aplicado: transferencia.",          total_duration_min=45),
            DoseStep(4, "12×50 snorkel", 24, 0.5, "BASE", "any", "Foco en alineación con snorkel. 600m.",            total_duration_min=45),
            DoseStep(5, "6×100 pull+nado",24, 0.5, "BASE", "any", "Pull técnico + nado correctivo. 600m completos.", total_duration_min=50),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            ...
            DoseStep(2, "3×500m c/30''",       30, 0.5,  "LT1", "any",    "Series más largas; mejor continuidad de brazada.", total_duration_min=52),
            DoseStep(3, "4×400m c/30''",       32, 0.5,  "LT1", "any",    "Añade una serie; primer volumen real de base continua.", total_duration_min=54),
            DoseStep(4, "4×500m c/30''",       40, 0.5,  "LT1", "medium", "40 minutos útiles; carga media-alta de base acuática.", total_duration_min=62),
            DoseStep(5, "2000m AEC frac.",     40, 0.5, "LT1", "medium", "Volumen alto fraccionado; reservar para atletas consolidados.", total_duration_min=63),
            DoseStep(6, "2500m AEC frac.",     50, 0.5, "LT1", "medium", "Carga máxima de base acuática; lectura de deriva.", total_duration_min=73),
        ),
    ),
    WorkoutTemplate(
        ...
        requires_fresh=True,
        dose_ladder=(
            DoseStep(1, "8×100m CSS c/15''",  14, 0.42, "LT2", "fresh", "Introducción; volumen contenido con referencia clara de ritmo.", total_duration_min=36),
            DoseStep(2, "6×150m CSS c/20''",  16, 0.42, "LT2", "fresh", "Repeticiones más largas; mejor especificidad metabólica.", total_duration_min=38),
            DoseStep(3, "10×100m CSS c/15''", 17, 0.42, "LT2", "fresh", "Más repeticiones; primer estímulo de umbral real.", total_duration_min=40),
            DoseStep(4, "6×200m CSS c/25''",  21, 0.42, "LT2", "fresh", "Mayor volumen por repetición; referencia clásica de umbral en natación.", total_duration_min=44),
            DoseStep(5, "4×300m CSS c/30''",  22, 0.42,  "LT2", "fresh", "Repeticiones largas; alta especificidad para distancias medias.", total_duration_min=46),
            DoseStep(6, "3×400m CSS c/45''",  23, 0.42, "LT2", "fresh", "Carga máxima; solo atletas con técnica estable y robustez alta.", total_duration_min=47),
        ),
    ),
    WorkoutTemplate(
        ...
        requires_fresh=True,
        dose_ladder=(
            DoseStep(1, "2×(4×100m) c/20''", 16, 0.33, "RACE", "medium", "Bloques rotos cortos: lectura del coste.",       total_duration_min=45),
            DoseStep(2, "3×(4×100m) c/20''", 24, 0.33, "RACE", "medium", "Progresión: más bloques a ritmo de prueba.",     total_duration_min=55),
            DoseStep(3, "2×(4×150m) c/20''", 24, 0.33, "RACE", "fresh",  "Repeticiones más largas: más especificidad.",    total_duration_min=55),
            DoseStep(4, "3×(4×150m) c/20''", 36, 0.33, "RACE", "fresh",  "Carga alta: bloques rotos largos.",             total_duration_min=65),
            DoseStep(5, "2×600m race pace",  30, 0.33,  "RACE", "fresh",  "Series continuas: máxima especificidad.",        total_duration_min=70),
        ),
    ),
    WorkoutTemplate(
        ...
        min_spacing_days_after=1,
        dose_ladder=(
            DoseStep(1, "3×(4×100m) c/15''", 24, 0.33, "LT1", "any",    "Series rotas; técnica limpia y lectura fácil del coste.", total_duration_min=47),
            DoseStep(2, "3×(4×150m) c/20''", 30, 0.33, "LT1", "any",    "Repeticiones más largas; mayor continuidad de brazada.", total_duration_min=53),
            DoseStep(3, "4×(4×100m) c/15''", 32, 0.33, "LT1", "any",    "Añade un bloque; primer volumen serio de base acuática.", total_duration_min=56),
            DoseStep(4, "4×(4×150m) c/20''", 40, 0.33, "LT1", "medium", "Carga media-alta; 40 minutos útiles en zona subumbral.", total_duration_min=64),
            DoseStep(5, "8×200m LT1 c/20''", 42, 0.33, "LT1", "medium", "Series medianas; transición hacia formato más específico.", total_duration_min=66),
            DoseStep(6, "6×300m LT1 c/25''", 48, 0.33, "LT1", "medium", "Series largas; máxima especificidad subumbral en piscina.", total_duration_min=72),
        ),
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        requires_fresh=True,
        dose_ladder=(
            DoseStep(1, "10×50m VO2",   500,  0.5, "VO2", "fresh",  "Introducción VO2 agua. 500m rápidos con pausa 30''.",        total_duration_min=40),
            DoseStep(2, "12×50m VO2",   600,  0.5, "VO2", "fresh",  "Progresión +2 reps. 600m VO2.",                             total_duration_min=45),
            DoseStep(3, "16×50m VO2",   800,  0.5, "VO2", "fresh",  "Volumen estándar VO2 en 50m.",                              total_duration_min=50),
            DoseStep(4, "8×75m VO2",    600,  0.5, "VO2", "fresh",  "Repeticiones más largas. Mayor densidad de VO2.",           total_duration_min=50),
            DoseStep(5, "10×100m VO2",  1000, 0.5,"VO2", "fresh",  "Carga máxima VO2. 1000m rápidos. Solo señal positiva.",     total_duration_min=55),
        ),
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        min_spacing_days_after=1,
        dose_ladder=(
            DoseStep(1, "2×400m OW",     16, 3.0, "RACE", "any",    "Introducción open water: sighting y orientación.",  total_duration_min=40),
            DoseStep(2, "3×400m OW",     24, 3.0, "RACE", "any",    "Más repeticiones con cambios de orientación.",      total_duration_min=50),
            DoseStep(3, "2×600m OW",     24, 3.0, "RACE", "medium", "Series más largas: mayor continuidad.",             total_duration_min=50),
            DoseStep(4, "3×600m OW",     36, 3.0, "RACE", "medium", "Carga alta: 1800m a ritmo de competición.",         total_duration_min=60),
            DoseStep(5, "2×1000m OW",    40, 3.0, "RACE", "fresh",  "Bloques largos: máxima especificidad de prueba.",   total_duration_min=65),
        ),
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        requires_fresh=True,
        dose_ladder=(
            DoseStep(1, "8×25m ANC",     4, 0.75, "ANC", "fresh", "Introducción: pocas reps, calidad máxima.",           total_duration_min=40),
            DoseStep(2, "12×25m ANC",    6, 0.75, "ANC", "fresh", "Volumen estándar: 300m casi-máximos.",                total_duration_min=45),
            DoseStep(3, "8×50m ANC",     8, 0.75,  "ANC", "fresh", "Repeticiones más largas: más tolerancia.",            total_duration_min=50),
            DoseStep(4, "2×(6×25m) ANC", 6, 0.75, "ANC", "fresh", "Bloques agrupados con macro-pausa entre sets.",      total_duration_min=50),
            DoseStep(5, "12×50m ANC",   12, 0.75,  "ANC", "fresh", "Dosis máxima: 600m. Solo élite con señal positiva.", total_duration_min=55),
        ),
    ),
    WorkoutTemplate(
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "4×20'' + 6×4' LT1",  25, 2.0, "BASE", "fresh", "Introducción mínima.", 55),
            DoseStep(2, "4×25'' + 7×4' LT1",  30, 2.0, "BASE", "fresh", "Volumen cola +1 rep.", 65),
            DoseStep(3, "5×25'' + 7×4' LT1",  30, 2.0, "BASE", "fresh", "+1 spice, cola igual.", 70),
            DoseStep(4, "5×30'' + 8×4' LT1",  35, 2.0, "BASE", "fresh", "Carga máxima AEC+spice.", 75),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "5×10'' + 5×7' LT1",  36, 2.0, "BASE", "fresh", "Intro conservadora.", 70),
            DoseStep(2, "5×10'' + 6×8' LT1",  49, 2.0, "BASE", "fresh", "Cola más larga.", 80),
            DoseStep(3, "6×10'' + 5×10' LT1", 51, 2.0, "BASE", "fresh", "Bloques LT1 más largos.", 90),
            DoseStep(4, "6×10'' + 6×10' LT1", 61, 2.0, "BASE", "fresh", "Carga máxima: máximo volumen LT1.", 100),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "6×8'' Q2",   1, 3.0, "ANC", "fresh", "ANC mínimo viable.", 60),
            DoseStep(2, "8×8'' Q2",   1, 3.0, "ANC", "fresh", "Volumen estándar del CSV.", 70),
            DoseStep(3, "10×8'' Q2",  2, 3.0, "ANC", "fresh", "Referencia principal Nacho.", 80),
            DoseStep(4, "12×10'' Q2", 2, 3.0, "ANC", "fresh", "Carga alta, solo atletas robustos.", 90),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "12-10-8-6' LT1",   36, 1.5, "BASE", "normal", "Intro escalado corto.", 36),
            DoseStep(2, "15-12-10-8' LT1",  45, 1.5, "BASE", "normal", "Escalado estándar.", 45),
            DoseStep(3, "15-12-10-8-6' LT1",51, 1.5, "BASE", "normal", "Formato completo del CSV.", 51),
            DoseStep(4, "20-15-12-10' LT1", 57, 1.5, "BASE", "normal", "Variante larga.", 57),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "6×30'' SIT + 3×15' LT1", 48, 2.0, "VO2", "fresh", "Intro SIT.", 90),
            DoseStep(2, "7×30'' SIT + 3×15' LT1", 49, 2.0, "VO2", "fresh", "Progresión +1 SIT.", 100),
            DoseStep(3, "8×30'' SIT + 4×12' LT1", 52, 2.0, "VO2", "fresh", "Carga máxima del CSV.", 110),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "8' LT1 + 20×20''/15''", 15, 2.0, "VO2", "fresh", "Intro: relación 20/15.", 55),
            DoseStep(2, "8' LT1 + 18×30''/20''", 17, 2.0, "VO2", "fresh", "Progresión T:D 30/20.", 60),
            DoseStep(3, "8' LT1 + 16×40''/30''", 19, 2.0, "VO2", "fresh", "Carga máxima 40/30.", 65),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "4×20'' ANC",    2, 1.0, "ANC",  "fresh", "Introducción: pocas repeticiones, máxima calidad.",     total_duration_min=55),
            DoseStep(2, "6×20'' ANC",    2, 1.0, "ANC",  "fresh", "Primer volumen real ANC running.",                       total_duration_min=60),
            DoseStep(3, "6×30'' ANC",    3, 1.0, "ANC",  "fresh", "Repeticiones más largas: más estímulo glucolítico.",     total_duration_min=65),
            DoseStep(4, "8×20'' ANC",    3, 1.0, "ANC",  "fresh", "Carga alta: 8 repeticiones explosivas.",                total_duration_min=70),
            DoseStep(5, "8×30'' ANC",    4, 1.0, "ANC",  "fresh", "Carga máxima. Solo con señal positiva y robustez alta.", total_duration_min=75),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "6×8'' ANC",   1, 2.0, "ANC",  "fresh", "Introducción; pocas repeticiones, máxima calidad.", 60),
            DoseStep(2, "8×8'' ANC",   1, 2.0, "ANC",  "fresh", "Primer volumen real ANC en bici.", 70),
            DoseStep(3, "10×8'' ANC",  2, 2.0, "ANC",  "fresh", "Clásico del CSV — referencia de la mayoría de sesiones.", 80),
            DoseStep(4, "12×10'' ANC", 2, 2.0, "ANC",  "fresh", "Carga alta; solo atletas robustos con señal positiva.", 90),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "8×25m ANC",     4, 0.67, "ANC", "fresh", "Introducción: pocas reps, calidad máxima.",          total_duration_min=45),
            DoseStep(2, "12×25m ANC",    6, 0.67, "ANC", "fresh", "Primer volumen real ANC acuático. 300m.",            total_duration_min=50),
            DoseStep(3, "16×25m ANC",    8, 0.67, "ANC", "fresh", "Progresión estándar. 400m de trabajo real.",         total_duration_min=55),
            DoseStep(4, "3×(4×25m) ANC", 6, 0.67, "ANC", "fresh", "Bloques agrupados con macro-pausa. 300m.",          total_duration_min=55),
            DoseStep(5, "20×25m ANC",   10, 0.67, "ANC", "fresh", "Dosis máxima: 500m. Solo élite con señal positiva.", total_duration_min=60),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "6×30m MAX",     2, 0.17, "ANP", "fresh", "Introducción ANP: pocas reps, calidad máxima.",       total_duration_min=55),
            DoseStep(2, "8×30m MAX",     2, 0.17, "ANP", "fresh", "Primer volumen real: 240m a velocidad máxima.",        total_duration_min=60),
            DoseStep(3, "8×50m MAX",     4, 0.17, "ANP", "fresh", "Repeticiones más largas: más tolerancia.",             total_duration_min=65),
            DoseStep(4, "10×50m MAX",    5, 0.17, "ANP", "fresh", "Carga alta: 500m máximos.",                            total_duration_min=70),
            DoseStep(5, "12×50m MAX",    6, 0.17, "ANP", "fresh", "Dosis máxima ANP. Solo 1-2 semanas.",                  total_duration_min=75),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "6×20'' MAX",    2, 0.17, "ANP", "fresh", "Introducción ANP bici: sprints cortos.",              total_duration_min=60),
            DoseStep(2, "8×20'' MAX",    3, 0.17, "ANP", "fresh", "Primer volumen real ANP.",                             total_duration_min=65),
            DoseStep(3, "10×20'' MAX",   3, 0.17, "ANP", "fresh", "Progresión estándar: más repeticiones.",               total_duration_min=70),
            DoseStep(4, "10×30'' MAX",   5, 0.17, "ANP", "fresh", "Repeticiones más largas: más tolerancia.",             total_duration_min=75),
            DoseStep(5, "12×30'' MAX",   6, 0.17, "ANP", "fresh", "Dosis máxima ANP bici. Solo 1-2 semanas.",             total_duration_min=80),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "8×25m MAX",     4, 0.13, "ANP", "fresh", "Introducción ANP natación: sprints cortos.",          total_duration_min=45),
            DoseStep(2, "10×25m MAX",    5, 0.13, "ANP", "fresh", "250m de trabajo máximo.",                              total_duration_min=50),
            DoseStep(3, "12×25m MAX",    6, 0.13, "ANP", "fresh", "Progresión: 300m a velocidad máxima.",                 total_duration_min=55),
            DoseStep(4, "8×50m MAX",     8, 0.13, "ANP", "fresh", "Reps largas: más tolerancia a la acidosis.",           total_duration_min=55),
            DoseStep(5, "2×(6×25m) MAX", 6, 0.13, "ANP", "fresh", "Bloques con macro-pausa. Máxima dosis.",               total_duration_min=60),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "3×20''+25'",   25, 1.0, "BASE", "any",    "3 strides + 25' sub-LT1. Dosis mínima de spice.",            total_duration_min=50),
            DoseStep(2, "4×20''+30'",   30, 1.0, "BASE", "any",    "4 strides + 30' sub-LT1. Progresión de cola.",               total_duration_min=55),
            DoseStep(3, "5×8''+35'",    35, 1.0, "BASE", "any",    "5 cuestas cortas + 35' sub-LT1. Patrón Olbrecht completo.",  total_duration_min=60),
            DoseStep(4, "4×30''+40'",   40, 1.0, "LT1",  "medium", "Strides más largos + 40' LT1. Transición a mayor carga.",    total_duration_min=65),
            DoseStep(5, "5×30''+45'",   45, 1.0, "LT1",  "medium", "Carga máxima. 5 spice + 45' extensivo. Solo señal positiva.", total_duration_min=70),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "4×8''+45'",    45, 1.0, "BASE", "any",    "4 arrancadas + 45' sub-LT1. Mínimo spice.",              total_duration_min=65),
            DoseStep(2, "5×10''+50'",   50, 1.0, "BASE", "any",    "5 arrancadas + 50' sub-LT1. Patrón CSV Nacho.",          total_duration_min=75),
            DoseStep(3, "5×10''+7×7'",  49, 1.0, "LT1",  "any",    "5 MAX + 7×7' LT1. Formato exacto del CSV.",             total_duration_min=85),
            DoseStep(4, "6×10''+60'",   60, 1.0, "LT1",  "medium", "Más arrancadas y más cola. Carga media-alta.",           total_duration_min=90),
            DoseStep(5, "6×12''+8×7'",  56, 1.0, "LT1",  "medium", "Carga máxima: 6 MAX largos + 56' LT1.",                 total_duration_min=95),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "6×25m+800m",    20, 0.67, "BASE", "any",    "6 ANC + 800m sub-LT1. Mínimo spice.",                total_duration_min=40),
            DoseStep(2, "8×25m+1000m",   25, 0.67, "BASE", "any",    "8 ANC + 1000m. Patrón base Olbrecht.",                total_duration_min=45),
            DoseStep(3, "8×25m+1200m",   30, 0.67, "BASE", "any",    "Cola más larga: más base aeróbica acuática.",         total_duration_min=50),
            DoseStep(4, "10×25m+1200m",  30, 0.67, "LT1",  "medium", "Más ANC + cola a LT1. Carga media-alta.",            total_duration_min=55),
            DoseStep(5, "10×25m+1500m",  38, 0.67, "LT1",  "medium", "Dosis máxima AEC spiced. 1500m de cola extensiva.",   total_duration_min=60),
        ),
    ),
    ...
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "8×400m c/15''",  16, 0.33, "RACE", "fresh",  "Introducción AEP: 3.2km a ritmo objetivo.",          total_duration_min=55),
            DoseStep(2, "10×400m c/15''",  20, 0.33, "RACE", "fresh",  "Progresión en repeticiones. 4km a ritmo.",           total_duration_min=60),
            DoseStep(3, "6×800m c/20''",   24, 0.33, "RACE", "fresh",  "Repeticiones más largas: más específico.",           total_duration_min=65),
            DoseStep(4, "8×800m c/20''",   32, 0.33, "RACE", "fresh",  "Carga alta: 6.4km a ritmo de prueba.",              total_duration_min=75),
            DoseStep(5, "5×1200m c/20''",  30, 0.33, "RACE", "fresh",  "Bloques largos: máxima especificidad AEP.",         total_duration_min=80),
        ),
    ),
    WorkoutTemplate(
        ...
        dose_ladder=(
            DoseStep(1, "20×50m c/15s",   20, 0.25, "RACE", "fresh",  "AEP Fase 1 Olbrecht: 1000m a ritmo de prueba.",         total_duration_min=45),
            DoseStep(2, "10×100m c/15s",   20, 0.25, "RACE", "fresh",  "AEP Fase 2: distancia doble, mismo descanso.",          total_duration_min=50),
            DoseStep(3, "6×200m c/15s",    24, 0.25, "RACE", "fresh",  "AEP Fase 3: 1200m en bloques de 200m.",                 total_duration_min=55),
            DoseStep(4, "3×(3×100m) c/15s",27, 0.25, "RACE", "fresh",  "Series agrupadas: 900m en 3 bloques con macro-pausa.", total_duration_min=55),
            DoseStep(5, "4×200m+2×400m",   28, 0.25, "RACE", "fresh",  "Mix largo: máxima especificidad AEP acuática.",         total_duration_min=60),
        ),
    ),
    ...
    # ── FIELD TESTS (for athletes without lactate) ─────────────────────────

    WorkoutTemplate(
        template_id="run_decoupling_test",
        discipline="running",
        session_family="field_test",
        session_role="key",
        compatible_block_types=("aerobic_capacity_block", "threshold_development_block", "aerobic_power_block", "competition_specific_block"),
        fatigue_cost=2,
        min_spacing_days_after=1,
        incompatible_adjacent_families=(),
        requires_fresh=True,
        public_label="Test de desacoplamiento cardiaco",
        summary="Test de campo para estimar LT1: 35 min a ritmo constante en terreno llano. Se analiza el drift HR.",
        objective="Determinar si un ritmo dado está por debajo, en la frontera, o por encima del umbral aeróbico (LT1) mediante el desacoplamiento pace:HR.",
        dose_guidance="15' calentamiento progresivo + 35' ritmo constante (terreno llano) + 10' vuelta a calma",
        progression_axes=("ritmo_target",),
        control_points=("FC estable durante el bloque", "Ritmo constante (CV <8%)", "Terreno llano", "Hidratación normal", "Temperatura <28°C"),
        expected_adaptations=("Localización progresiva del LT1 mediante búsqueda binaria",),
        cautions=("Calor >28°C invalida parcialmente el resultado", "Deshidratación amplifica el drift", "No hacer después de sesión intensa"),
        dose_ladder=(),
        csv_examples=("15' calentamiento + 35' @ritmo_target + 10' trote suave",),
        calentamiento_min=15,
        calentamiento_template="15' progresivo de muy suave a ritmo cómodo",
        enfriamiento_min=10,
        enfriamiento_template="10' trote muy suave",
        coach_tips=(
            "El entrenador fija el ritmo target según intuición o test previo.",
            "Primera vez: elegir un ritmo conversacional cómodo.",
            "Si el resultado es 'acoplado', el siguiente test sube ritmo 10-15 s/km.",
            "Si es 'desacoplado', el siguiente test baja ritmo 10-15 s/km.",
            "Buscar el punto 'borderline' (3.5-5% drift) en 2-3 tests.",
        ),
        confidence=0.70,
        evidence_ids=("coyle_2001", "friel_decoupling", "wingo_2005"),
    ),

    WorkoutTemplate(
        template_id="run_time_trial_30",
        discipline="running",
        session_family="field_test",
        session_role="key",
        compatible_block_types=("aerobic_capacity_block", "threshold_development_block", "aerobic_power_block", "competition_specific_block"),
        ...
        incompatible_adjacent_families=("lt2_cruise_intervals", "threshold_continuous", "vo2_hills"),
        requires_fresh=True,
        public_label="Contrarreloj 30 minutos",
        summary="Test de campo para estimar LT2: 30 min a máximo esfuerzo sostenible. El ritmo medio ≈ MLSS.",
        objective="Estimar el ritmo en MLSS/LT2 como el ritmo medio sostenido durante 30 min de esfuerzo máximo bien paceado.",
        dose_guidance="15' calentamiento + 30' all-out sostenible + 10' vuelta a calma",
        progression_axes=("ritmo_medio",),
        control_points=("Paceo uniforme (split <3%)", "Terreno llano o circuito", "Atleta descansado", "El entrenador guía el ritmo inicial"),
        expected_adaptations=("Determinación directa del ritmo en LT2/MLSS",),
        cautions=("Requiere buen paceo — si la segunda mitad es >5% más lenta, repetir", "No hacer tras sesión dura", "Calor >28°C contamina el resultado"),
        dose_ladder=(),
        csv_examples=("15' calentamiento + 30' máximo esfuerzo sostenible + 10' trote suave",),
        calentamiento_min=15,
        calentamiento_template="15' progresivo con 3×30'' a ritmo de test",
        enfriamiento_min=10,
        enfriamiento_template="10' trote muy suave",
        coach_tips=(
            "Indicación al atleta: 'el ritmo más rápido que puedas mantener 30 minutos sin desplomarte'.",
            "Guiar los primeros 5 min: mejor salir 5 s/km más lento que demasiado rápido.",
            "Si el pacing es malo (>5% positive split), el resultado se descarta — repetir en 1-2 semanas.",
            "Terreno ideal: pista de atletismo, circuito llano conocido, o cinta.",
        ),
        confidence=0.70,
        evidence_ids=("borszcz_2019", "mlss_definition"),
    ),
)
...
WORKOUT_BLUEPRINTS: dict[tuple[str, str], dict[str, tuple[DraftSlot, ...]]] = {
    ...
    ("running", "aerobic_capacity_block"): {
        "load":       (DraftSlot(2, "run_lt1_extensive", ("run_lt1_long_reps", "run_escalated_lt1")),
                       DraftSlot(4, "run_economy_strides", ("run_progressive_aerobic",)),
                       DraftSlot(6, "run_long_aerobic", ("run_regenerative_long",)),
                       DraftSlot(1, "strength_general_support")),
        "build":      (DraftSlot(2, "run_lt1_long_reps", ("run_lt1_extensive", "run_escalated_lt1")),
                       DraftSlot(4, "run_lt1_extensive", ("run_progressive_aerobic", "run_economy_strides")),
                       DraftSlot(6, "run_long_aerobic", ("run_regenerative_long",))),
        "build_peak": (DraftSlot(2, "run_anc_submax_spice"),
                       DraftSlot(4, "run_lt1_long_reps", ("run_escalated_lt1",)),
                       DraftSlot(6, "run_regenerative_long", ("run_long_aerobic",))),
        "recovery":   (DraftSlot(2, "run_lt0_recovery"),
                       DraftSlot(4, "run_economy_strides", ("run_progressive_aerobic",)),
                       DraftSlot(6, "recovery_regeneration")),
    },
    ("running", "threshold_development_block"): {
        "load":       (DraftSlot(2, "run_lt2_cruise", ("run_subthreshold_reps", "run_threshold_continuous", "run_lt2_short_reps")),
                       DraftSlot(4, "run_lt1_extensive", ("run_lt1_long_reps", "run_progressive_aerobic")),
                       DraftSlot(6, "run_long_aerobic", ("run_regenerative_long",)),
                       DraftSlot(1, "strength_general_support")),
        "build":      (DraftSlot(2, "run_subthreshold_reps", ("run_lt2_cruise", "run_lt1_lt2_mix", "run_subthreshold_3min")),
                       DraftSlot(4, "run_lt1_long_reps", ("run_lt1_extensive", "run_escalated_lt1")),
                       DraftSlot(6, "run_progressive_aerobic", ("run_long_aerobic",))),
        "build_peak": (DraftSlot(2, "run_escalated_lt1", ("run_lt1_lt2_mix", "run_escalated_intervals")),
                       DraftSlot(4, "run_lt1_lt2_mix", ("run_subthreshold_reps",)),
                       DraftSlot(6, "run_long_aerobic")),
        "recovery":   (DraftSlot(2, "run_lt0_recovery"),
                       DraftSlot(5, "run_lt1_extensive", ("run_progressive_aerobic",)),
                       DraftSlot(6, "test_profile_anchor")),
    },
    ("running", "aerobic_power_block"): {
        "load":       (DraftSlot(2, "run_uLT1_vo2_combo", ("run_anc_vo2_short",)),
                       DraftSlot(4, "run_lt1_extensive", ("run_lt1_long_reps",)),
                       DraftSlot(6, "run_long_aerobic", ("run_regenerative_long",))),
        "build":      (DraftSlot(2, "run_vo2_hills", ("run_uLT1_vo2_combo", "run_anc_vo2_short")),
                       DraftSlot(5, "run_hill_sprints", ("run_economy_strides",)),
                       DraftSlot(6, "run_lt1_extensive", ("run_progressive_aerobic",))),
        "build_peak": (DraftSlot(2, "run_anc_vo2_short", ("run_vo2_hills", "run_vo2_30_30")),
                       DraftSlot(4, "run_vo2_hills", ("run_uLT1_vo2_combo",)),
                       DraftSlot(6, "run_lt1_extensive", ("run_long_aerobic",))),
        "recovery":   (DraftSlot(2, "run_lt0_recovery"),
                       DraftSlot(5, "run_economy_strides"),
                       DraftSlot(6, "test_profile_anchor")),
    },
    ("running", "competition_specific_block"): {
        "load":     (DraftSlot(2, "run_specific_durability", ("run_lt2_cruise", "run_halfpace_progressive")),
                     DraftSlot(4, "run_lt2_cruise", ("run_subthreshold_reps",)),
                     DraftSlot(6, "run_long_aerobic")),
        "specific": (DraftSlot(2, "run_specific_pace_reps", ("run_aep_race_pace",)),
                     DraftSlot(5, "run_hill_sprints", ("run_economy_strides",)),
                     DraftSlot(6, "recovery_regeneration")),
        "recovery": (DraftSlot(2, "run_lt0_recovery"),
                     DraftSlot(5, "test_profile_anchor")),
    },
    ("running", "technical_rebuild_block"): {
        "load":       (DraftSlot(2, "run_economy_strides", ("run_hill_sprints",)),
                       DraftSlot(4, "run_progressive_aerobic", ("run_lt1_extensive",)),
                       DraftSlot(1, "strength_general_support")),
        "build":      (DraftSlot(2, "run_economy_strides", ("run_hill_sprints",)),
                       DraftSlot(4, "run_lt1_extensive", ("run_progressive_aerobic",)),
                       DraftSlot(6, "run_long_aerobic", ("run_regenerative_long",))),
        "build_peak": (DraftSlot(2, "run_hill_sprints", ("run_economy_strides",)),
                       DraftSlot(4, "run_economy_strides", ("run_progressive_aerobic",)),
                       DraftSlot(6, "run_progressive_aerobic")),
        "recovery":   (DraftSlot(2, "run_lt0_recovery"),
                       DraftSlot(5, "run_hill_sprints")),
    },
    # ── Ciclismo ──────────────────────────────────────────────────────────────
    ("ciclismo", "technical_rebuild_block"): {
        "load":       (DraftSlot(2, "bike_cadence_efficiency", ("bike_torque_support",)),
                       DraftSlot(4, "bike_torque_support", ("bike_cadence_efficiency",)),
                       DraftSlot(1, "strength_general_support")),
        "build":      (DraftSlot(2, "bike_cadence_efficiency", ("bike_torque_support",)),
                       DraftSlot(4, "bike_lt1_blocks", ("bike_fatmax_endurance",)),
                       DraftSlot(6, "bike_long_endurance")),
        "build_peak": (DraftSlot(2, "bike_torque_support", ("bike_cadence_efficiency",)),
                       DraftSlot(4, "bike_cadence_efficiency", ("bike_torque_support",)),
                       DraftSlot(6, "bike_fatmax_endurance")),
        "recovery":   (DraftSlot(2, "bike_lt0_recovery"),
                       DraftSlot(5, "bike_lt1_blocks")),
    },
    ("ciclismo", "aerobic_capacity_block"): {
        "load":       (DraftSlot(2, "bike_lt1_blocks", ("bike_fatmax_endurance", "bike_cadence_efficiency")),
                       DraftSlot(4, "bike_torque_support", ("bike_cadence_efficiency",)),
                       DraftSlot(6, "bike_long_endurance", ("bike_fatmax_endurance",)),
                       DraftSlot(1, "strength_general_support")),
        "build":      (DraftSlot(2, "bike_fatmax_endurance", ("bike_lt1_blocks",)),
                       DraftSlot(5, "bike_cadence_efficiency", ("bike_torque_support",)),
                       DraftSlot(6, "bike_long_endurance", ("bike_fatmax_endurance", "bike_fatmax_intervals"))),
        "build_peak": (DraftSlot(2, "bike_anc_submax_spice"),
                       DraftSlot(4, "bike_lt1_blocks", ("bike_fatmax_endurance", "bike_cadmax_lt1_combo")),
                       DraftSlot(6, "bike_long_endurance")),
        "recovery":   (DraftSlot(2, "bike_lt0_recovery"),
                       DraftSlot(5, "bike_lt1_blocks", ("bike_cadence_efficiency",)),
                       DraftSlot(6, "test_profile_anchor")),
    },
    ("ciclismo", "threshold_development_block"): {
        "load":       (DraftSlot(2, "bike_lt2_halfpace", ("bike_subthreshold_blocks", "bike_over_under_threshold", "bike_endurance_tempo", "bike_lt1_to_lt2_blocks")),
                       DraftSlot(4, "bike_lt1_blocks", ("bike_fatmax_endurance",)),
                       DraftSlot(6, "bike_long_endurance")),
        "build":      (DraftSlot(2, "bike_subthreshold_blocks", ("bike_lt2_halfpace", "bike_over_under_threshold", "bike_lt2_torque_reps")),
                       DraftSlot(5, "bike_lt1_blocks", ("bike_cadence_efficiency",)),
                       DraftSlot(6, "bike_fatmax_endurance", ("bike_long_endurance",))),
        "build_peak": (DraftSlot(2, "bike_over_under_threshold", ("bike_subthreshold_blocks", "bike_lt2_long_reps", "bike_lt2_halfpace_long")),
                       DraftSlot(5, "bike_aero_stability", ("bike_lt2_halfpace",)),
                       DraftSlot(6, "bike_fatmax_endurance")),
        "recovery":   (DraftSlot(2, "bike_lt0_recovery"),
                       DraftSlot(5, "bike_lt1_blocks"),
                       DraftSlot(6, "test_profile_anchor")),
    ...
    ("ciclismo", "aerobic_power_block"): {
        "load":       (DraftSlot(2, "bike_vo2_power", ("bike_sit_lt1_progressive",)),
                       DraftSlot(4, "bike_lt1_blocks", ("bike_fatmax_endurance",)),
                       DraftSlot(6, "bike_torque_support", ("bike_long_endurance",))),
        "build":      (DraftSlot(2, "bike_vo2_power", ("bike_sit_lt1_progressive", "bike_vo2_30_30")),
                       DraftSlot(5, "bike_sprint_neuromuscular", ("bike_torque_support",)),
                       DraftSlot(6, "bike_long_endurance", ("bike_fatmax_endurance",))),
        "build_peak": (DraftSlot(2, "bike_sit_lt1_progressive", ("bike_vo2_power",)),
                       DraftSlot(5, "bike_vo2_power", ("bike_sprint_neuromuscular", "bike_lt2_vo2_combo")),
                       DraftSlot(6, "bike_long_endurance")),
        "recovery":   (DraftSlot(2, "bike_lt0_recovery"),
                       DraftSlot(5, "bike_lt1_blocks"),
                       DraftSlot(6, "test_profile_anchor")),
    ...
    ("ciclismo", "competition_specific_block"): {
        "load":     (DraftSlot(2, "bike_lt2_halfpace", ("bike_over_under_threshold",)),
                     DraftSlot(5, "bike_transition_specific", ("bike_aero_stability",)),
                     DraftSlot(6, "bike_long_endurance")),
        "specific": (DraftSlot(2, "bike_transition_specific", ("bike_aero_stability",)),
                     DraftSlot(4, "bike_aero_stability", ("bike_transition_specific",)),
                     DraftSlot(6, "recovery_regeneration")),
        "recovery": (DraftSlot(2, "bike_lt0_recovery"),
                     DraftSlot(5, "test_profile_anchor")),
    },
    ...
    ("natación", "technical_rebuild_block"): {
        "load":       (DraftSlot(1, "swim_technical_alignment", ("swim_pull_snorkel_alignment",)),
                       DraftSlot(3, "swim_pull_snorkel_alignment", ("swim_technical_alignment",)),
                       DraftSlot(5, "strength_general_support")),
        "build":      (DraftSlot(1, "swim_technical_alignment", ("swim_pull_snorkel_alignment",)),
                       DraftSlot(4, "swim_aerobic_continuity", ("swim_lt1_broken_sets",)),
                       DraftSlot(6, "swim_speed_turns")),
        "build_peak": (DraftSlot(1, "swim_pull_snorkel_alignment", ("swim_technical_alignment",)),
                       DraftSlot(4, "swim_technical_alignment", ("swim_speed_turns",)),
                       DraftSlot(6, "swim_aerobic_continuity")),
        "recovery":   (DraftSlot(2, "swim_recovery_drills"),
                       DraftSlot(5, "test_profile_anchor")),
    },
    ("natación", "aerobic_capacity_block"): {
        "load":       (DraftSlot(1, "swim_aerobic_continuity", ("swim_lt1_broken_sets", "swim_aec_long_session")),
                       DraftSlot(3, "swim_technical_alignment", ("swim_pull_snorkel_alignment",)),
                       DraftSlot(5, "swim_lt1_broken_sets", ("swim_aerobic_continuity",))),
        "build":      (DraftSlot(1, "swim_lt1_broken_sets", ("swim_aerobic_continuity", "swim_aec_long_session")),
                       DraftSlot(3, "swim_pull_snorkel_alignment", ("swim_technical_alignment",)),
                       DraftSlot(6, "swim_aerobic_continuity", ("swim_lt1_broken_sets", "swim_aec_base"))),
        "build_peak": (DraftSlot(1, "swim_anc_capacity_sets"),
                       DraftSlot(3, "swim_lt1_broken_sets", ("swim_aec_long_session",)),
                       DraftSlot(6, "swim_aec_long_session", ("swim_aerobic_continuity",))),
        "recovery":   (DraftSlot(2, "swim_recovery_drills"),
                       DraftSlot(5, "swim_technical_alignment")),
    },
    ("natación", "threshold_development_block"): {
        "load":       (DraftSlot(1, "swim_css_threshold", ("swim_aep_pace_sets",)),
                       DraftSlot(3, "swim_technical_alignment", ("swim_pull_snorkel_alignment",)),
                       DraftSlot(5, "swim_lt1_broken_sets", ("swim_aerobic_continuity",))),
        "build":      (DraftSlot(1, "swim_css_threshold", ("swim_aep_pace_sets", "swim_team_quality")),
                       DraftSlot(4, "swim_pull_snorkel_alignment", ("swim_technical_alignment",)),
                       DraftSlot(6, "swim_aerobic_continuity", ("swim_lt1_broken_sets",))),
        "build_peak": (DraftSlot(1, "swim_aep_pace_sets", ("swim_css_threshold",)),
                       DraftSlot(3, "swim_css_threshold", ("swim_aep_pace_sets",)),
                       DraftSlot(6, "swim_aerobic_continuity")),
        "recovery":   (DraftSlot(2, "swim_recovery_drills"),
                       DraftSlot(5, "swim_technical_alignment")),
    },
    ("natación", "aerobic_power_block"): {
        "load":       (DraftSlot(1, "swim_vo2_anaerobic", ("swim_aep_pace_sets",)),
                       DraftSlot(3, "swim_technical_alignment", ("swim_pull_snorkel_alignment",)),
                       DraftSlot(5, "swim_aerobic_continuity", ("swim_lt1_broken_sets",))),
        "build":      (DraftSlot(1, "swim_vo2_anaerobic", ("swim_aep_pace_sets",)),
                       DraftSlot(3, "swim_pull_snorkel_alignment", ("swim_technical_alignment",)),
                       DraftSlot(6, "swim_lt1_broken_sets", ("swim_aerobic_continuity",))),
        "build_peak": (DraftSlot(1, "swim_aep_pace_sets", ("swim_vo2_anaerobic",)),
                       DraftSlot(3, "swim_vo2_anaerobic", ("swim_aep_pace_sets",)),
                       DraftSlot(6, "swim_aerobic_continuity")),
        "recovery":   (DraftSlot(2, "swim_recovery_drills"),
                       DraftSlot(5, "swim_technical_alignment")),
    },
    ("natación", "competition_specific_block"): {
        "load":     (DraftSlot(1, "swim_css_threshold", ("swim_aep_pace_sets",)),
                     DraftSlot(3, "swim_race_pace_specific", ("swim_open_water_specific",)),
                     DraftSlot(5, "swim_pull_snorkel_alignment", ("swim_technical_alignment",))),
        "specific": (DraftSlot(1, "swim_open_water_specific", ("swim_race_pace_specific",)),
                     DraftSlot(4, "swim_speed_turns"),
                     DraftSlot(6, "recovery_regeneration")),
        "recovery": (DraftSlot(2, "swim_recovery_drills"),
                     DraftSlot(5, "swim_technical_alignment")),
    },
    ...
    ("running", "anaerobic_capacity_block"): {
        "load":       (DraftSlot(2, "run_aec_spiced", ("run_anc_submax_spice",)),
                       DraftSlot(4, "run_lt1_extensive", ("run_lt1_long_reps",)),
                       DraftSlot(6, "run_long_aerobic", ("run_regenerative_long",))),
        "build":      (DraftSlot(2, "run_anc_submax_spice", ("run_anc_short_reps",)),
                       DraftSlot(4, "run_lt1_long_reps", ("run_lt1_extensive", "run_escalated_lt1")),
                       DraftSlot(6, "run_regenerative_long", ("run_long_aerobic",))),
        "build_peak": (DraftSlot(2, "run_anc_short_reps", ("run_anc_submax_spice",)),
                       DraftSlot(4, "run_lt1_long_reps", ("run_escalated_lt1",)),
                       DraftSlot(6, "run_regenerative_long")),
        "recovery":   (DraftSlot(2, "run_lt0_recovery"),
                       DraftSlot(5, "run_economy_strides"),
                       DraftSlot(6, "recovery_regeneration")),
    },
    ("ciclismo", "anaerobic_capacity_block"): {
        "load":       (DraftSlot(2, "bike_aec_spiced", ("bike_anc_submax_spice",)),
                       DraftSlot(4, "bike_lt1_blocks", ("bike_fatmax_endurance",)),
                       DraftSlot(6, "bike_long_endurance")),
        "build":      (DraftSlot(2, "bike_anc_submax_spice", ("bike_anc_power_sprints", "bike_fuerza_q2")),
                       DraftSlot(5, "bike_lt1_blocks", ("bike_fatmax_endurance",)),
                       DraftSlot(6, "bike_fatmax_endurance", ("bike_long_endurance",))),
        "build_peak": (DraftSlot(2, "bike_anc_power_sprints", ("bike_anc_submax_spice",)),
                       DraftSlot(5, "bike_lt1_blocks"),
                       DraftSlot(6, "bike_fatmax_endurance")),
        "recovery":   (DraftSlot(2, "bike_lt0_recovery"),
                       DraftSlot(5, "bike_lt1_blocks"),
    ...
    ("natación", "anaerobic_capacity_block"): {
        "load":       (DraftSlot(1, "swim_aec_spiced", ("swim_anc_capacity_sets",)),
                       DraftSlot(3, "swim_aerobic_continuity", ("swim_lt1_broken_sets",)),
                       DraftSlot(5, "swim_technical_alignment", ("swim_pull_snorkel_alignment",))),
        "build":      (DraftSlot(1, "swim_anc_capacity_sets", ("swim_anc_speed_combo",)),
                       DraftSlot(3, "swim_lt1_broken_sets", ("swim_aerobic_continuity",)),
                       DraftSlot(6, "swim_aec_long_session")),
        "build_peak": (DraftSlot(1, "swim_anc_speed_combo", ("swim_anc_capacity_sets",)),
                       DraftSlot(3, "swim_lt1_broken_sets"),
                       DraftSlot(6, "swim_aec_long_session")),
        "recovery":   (DraftSlot(2, "swim_recovery_drills"),
                       DraftSlot(5, "swim_technical_alignment")),
    },
    ...
    ("running", "anaerobic_power_block"): {
        "load":     (DraftSlot(2, "run_anp_sprint_tolerance", ("run_aep_race_pace",)),
                     DraftSlot(4, "run_lt1_extensive", ("run_lt1_long_reps",)),
                     DraftSlot(6, "run_regenerative_long")),
        "specific": (DraftSlot(2, "run_aep_race_pace", ("run_anp_sprint_tolerance",)),
                     DraftSlot(5, "run_anp_sprint_tolerance", ("run_hill_sprints",)),
                     DraftSlot(6, "run_lt0_recovery")),
        "recovery": (DraftSlot(2, "run_lt0_recovery"),
                     DraftSlot(5, "test_profile_anchor")),
    },
    ("ciclismo", "anaerobic_power_block"): {
        "load":     (DraftSlot(2, "bike_anp_high_intensity", ("bike_sprint_neuromuscular",)),
                     DraftSlot(4, "bike_lt1_blocks", ("bike_fatmax_endurance",)),
                     DraftSlot(6, "bike_long_endurance")),
        "specific": (DraftSlot(2, "bike_anp_high_intensity", ("bike_sprint_neuromuscular",)),
                     DraftSlot(5, "bike_aero_stability", ("bike_transition_specific",)),
                     DraftSlot(6, "recovery_regeneration")),
        "recovery": (DraftSlot(2, "bike_lt0_recovery"),
                     DraftSlot(5, "test_profile_anchor")),
    },
    ("natación", "anaerobic_power_block"): {
        "load":     (DraftSlot(1, "swim_anp_tolerance", ("swim_aep_pace_sets",)),
                     DraftSlot(3, "swim_aerobic_continuity", ("swim_lt1_broken_sets",)),
                     DraftSlot(5, "swim_technical_alignment")),
        "specific": (DraftSlot(1, "swim_aep_pace_sets", ("swim_anp_tolerance",)),
                     DraftSlot(4, "swim_anp_tolerance", ("swim_aep_pace_sets",)),
                     DraftSlot(6, "swim_recovery_drills")),
        "recovery": (DraftSlot(2, "swim_recovery_drills"),
                     DraftSlot(5, "test_profile_anchor")),
    },
    ...
    ("running", "recovery_consolidation_block"): {
        "load":     (DraftSlot(2, "run_lt0_recovery"),
                     DraftSlot(4, "run_progressive_aerobic", ("run_economy_strides",)),
                     DraftSlot(6, "run_long_aerobic", ("run_regenerative_long",))),
        "build":    (DraftSlot(2, "run_lt1_extensive", ("run_progressive_aerobic",)),
                     DraftSlot(5, "run_economy_strides", ("run_progressive_aerobic",)),
                     DraftSlot(6, "run_regenerative_long", ("run_long_aerobic",))),
        "recovery": (DraftSlot(2, "run_lt0_recovery"),
                     DraftSlot(5, "recovery_regeneration")),
    },
    ("ciclismo", "recovery_consolidation_block"): {
        "load":     (DraftSlot(2, "bike_lt0_recovery"),
                     DraftSlot(4, "bike_fatmax_endurance", ("bike_cadence_efficiency",)),
                     DraftSlot(6, "bike_long_endurance")),
        "build":    (DraftSlot(2, "bike_lt1_blocks", ("bike_fatmax_endurance",)),
                     DraftSlot(5, "bike_cadence_efficiency", ("bike_torque_support",)),
                     DraftSlot(6, "bike_fatmax_endurance", ("bike_long_endurance",))),
        "recovery": (DraftSlot(2, "bike_lt0_recovery"),
                     DraftSlot(5, "recovery_regeneration")),
    ...
    ("natación", "recovery_consolidation_block"): {
        "load":     (DraftSlot(1, "swim_recovery_drills"),
                     DraftSlot(3, "swim_aerobic_continuity", ("swim_lt1_broken_sets",)),
                     DraftSlot(5, "swim_technical_alignment", ("swim_pull_snorkel_alignment",))),
        "build":    (DraftSlot(1, "swim_lt1_broken_sets", ("swim_aerobic_continuity",)),
                     DraftSlot(4, "swim_pull_snorkel_alignment", ("swim_technical_alignment",)),
                     DraftSlot(6, "swim_aerobic_continuity")),
        "recovery": (DraftSlot(2, "swim_recovery_drills"),
                     DraftSlot(5, "swim_lt0_50s")),
    },
}

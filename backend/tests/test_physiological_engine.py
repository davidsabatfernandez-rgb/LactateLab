...
VALIDATION_BATTERY = [
    ...
    # S04: gap=0.17 km/h > moderate_gap(0.15) → AEP en pre_comp (no competition_specific)
    pytest.param(_pace_analysis("natación", 940, 900), "competitive", "natación", "pool_800_1500", _pace(890), None, 7, 8.8, "aerobic_power_block", id="S04_pool1500_specific"),

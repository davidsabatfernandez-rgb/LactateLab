...
const ZONE_PRESETS: Record<string, { label: string; color: string; description: string }[]> = {
  running: [
    { label: "REC", color: "#3a9a5b", description: "Trote suave, recuperación activa." },
    { label: "BASE", color: "#2e8b57", description: "Base aeróbica, conversación cómoda. Incluye sub-LT1." },
    { label: "LT1", color: "#b58a2e", description: "Zona de LT1 práctico. Intensidad de referencia para sesiones LT1." },
    { label: "SUB", color: "#d4a017", description: "Entre LT1 y LT2 prácticos. Maratón pace, medio fondo." },
    { label: "LT2", color: "#c27a2e", description: "Zona de LT2 práctico. Referencia para intervalos de umbral." },
    { label: "VO2MAX", color: "#c44040", description: "Potencia aeróbica máxima, intervalos 2-6 min." },
    { label: "ANC", color: "#7c3aed", description: "Capacidad anaeróbica, esfuerzos <2 min." },
  ],
  ciclismo: [
    { label: "REC", color: "#3a9a5b", description: "Pedaleo suave, recuperación activa." },
    { label: "BASE", color: "#2e8b57", description: "Base aeróbica, larga duración." },
    { label: "LT1", color: "#b58a2e", description: "Esfuerzo sostenido sub-LT1." },
    { label: "SUB", color: "#d4a017", description: "Entre LT1 y LT2, tempo sostenido." },
    { label: "LT2", color: "#c27a2e", description: "Potencia de umbral funcional, ~40-60 min." },
    { label: "VO2MAX", color: "#c44040", description: "Potencia aeróbica máxima, intervalos 3-8 min." },
    { label: "ANC", color: "#7c3aed", description: "Capacidad anaeróbica, esfuerzos <2 min." },
  ],
  natacion: [
    { label: "REC", color: "#3a9a5b", description: "Nado suave, técnica y recuperación." },
    { label: "BASE", color: "#2e8b57", description: "Resistencia aeróbica, larga distancia." },
    { label: "LT1", color: "#b58a2e", description: "Nado constante sub-CSS." },
    { label: "SUB", color: "#d4a017", description: "Justo debajo de CSS, series 400-1000m." },
    { label: "LT2", color: "#c27a2e", description: "Critical Swim Speed, series 100-400m." },
    { label: "VO2MAX", color: "#c44040", description: "Intervalos 50-200m a máxima intensidad aeróbica." },
    { label: "ANC", color: "#7c3aed", description: "Sprints 25-100m, velocidad máxima." },
  ],
};

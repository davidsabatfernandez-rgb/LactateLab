...
const BETA_T: Record<string, Record<string, string>> = {
  es: {
    ...
    hero_sub: "An\u00E1lisis de lactato multi-m\u00E9todo, zonas reales y planes de entrenamiento personalizados.",
    hero_cta: "Prueba gratis",
    hero_note: "Beta privada \u00B7 Plazas limitadas",

    problem_ey: "El problema",
    problem_h2: "El 70% entrena con zonas equivocadas",
    problem_1: "220\u2212edad tiene \u00B110-20 ppm de error",
    problem_2: "Zonas de running \u2260 zonas de ciclismo",
    problem_3: "Un test sin an\u00E1lisis es un n\u00FAmero en una libreta",
    problem_4: "VLamax y predicciones necesitan m\u00E1s que un Excel",

    how_ey: "C\u00F3mo funciona",
    how_1_title: "Sube tu test",
    how_1_text: "Cualquier protocolo, cualquier formato. Tambi\u00E9n puedes empezar solo con FC.",
    ...
    demo_ey: "Pru\u00E9balo",
    demo_h2: "Sube datos de ejemplo y mira el an\u00E1lisis en directo",

    ap_ey: "Tu portal de atleta",
    ap_h2: "Todo en una app",
    ap_1_title: "Tu d\u00EDa, de un vistazo",
    ap_1_desc: "Readiness, sesi\u00F3n detallada y m\u00E9tricas de bienestar.",
    ap_2_title: "Semana y calendario",
    ap_2_desc: "Vista semanal con distribuci\u00F3n por zonas y volumen.",
    ap_3_title: "Evoluci\u00F3n de umbrales",
    ap_3_desc: "Evoluci\u00F3n de LT1/LT2 test a test con tendencia.",
    ap_4_title: "Zonas reales",
    ap_4_desc: "7 zonas desde lactato real. FC, ritmo y potencia.",
    ap_5_title: "Objetivos de carrera",
    ap_5_desc: "Define carreras con fecha y marca. El plan se adapta.",
    ap_6_title: "Predicciones",
    ap_6_desc: "Predicciones para 5K a marat\u00F3n con bandas de confianza.",
    ...
    faq_q3: "\u00BFNecesito un medidor de lactato caro?",
    faq_a3: "Los medidores port\u00E1tiles cuestan 150-300\u20AC (Lactate Plus, Lactate Pro 2). Es la misma inversi\u00F3n que 1-2 tests de laboratorio, pero puedes hacer tests ilimitados.",
    faq_q4: "\u00BFPuedo usar los datos de mi Garmin/Strava?",
    faq_a4: "Puedes usar tu FC m\u00E1xima y reposo de Garmin/Strava para zonas iniciales. Pero las zonas que te dan est\u00E1n basadas en 220-edad \u2014 una f\u00F3rmula con \u00B110-20 ppm de error.",
    faq_q5: "\u00BFQu\u00E9 es la beta privada?",
    faq_a5: "Acceso anticipado limitado. Revisamos cada solicitud personalmente.",
    faq_q6: "\u00BFQu\u00E9 deporte cubre?",
    faq_a6: "Running, ciclismo, nataci\u00F3n y triatl\u00F3n. Con zonas espec\u00EDficas por deporte.",
    faq_q7: "\u00BFMis datos est\u00E1n seguros?",
    faq_a7: "Tus datos son tuyos. No compartimos nada con terceros.",
  ...
  en: {
    ...
    hero_sub: "Multi-method lactate analysis, real zones and personalized training plans.",
    hero_cta: "Try free",
    hero_note: "Private beta \u00B7 Limited spots",

    problem_ey: "The problem",
    problem_h2: "70% train with wrong zones",
    problem_1: "220\u2212age has \u00B110-20 bpm error",
    problem_2: "Running zones \u2260 cycling zones",
    problem_3: "A test without analysis is a number in a notebook",
    problem_4: "VLamax and predictions need more than a spreadsheet",

    how_ey: "How it works",
    how_1_title: "Upload your test",
    how_1_text: "Any protocol, any format. You can also start with HR only.",
    ...
    how_3_text: "Objective-based plans that target your weak points. They adapt week by week.",

    demo_ey: "Try it",
    demo_h2: "Upload sample data and see the analysis live",

    ap_ey: "Your athlete portal",
    ap_h2: "Everything in one app",
    ap_1_title: "Your day, at a glance",
    ap_1_desc: "Readiness, detailed session and wellness metrics.",
    ap_2_title: "Week and calendar",
    ap_2_desc: "Weekly view with zone distribution and volume.",
    ap_3_title: "Threshold evolution",
    ap_3_desc: "LT1/LT2 evolution test by test with trend.",
    ap_4_title: "Real zones",
    ap_4_desc: "7 zones from real lactate. HR, pace and power.",
    ap_5_title: "Race objectives",
    ap_5_desc: "Define races with date and goal. The plan adapts.",
    ap_6_title: "Predictions",
    ap_6_desc: "Predictions for 5K to marathon with confidence bands.",
    ...
    faq_q3: "Do I need an expensive lactate meter?",
    faq_a3: "Portable meters cost \u20AC150-300 (Lactate Plus, Lactate Pro 2). Same investment as 1-2 lab tests, but you can test unlimited times.",
    faq_q4: "Can I use my Garmin/Strava data?",
    faq_a4: "You can use your max HR and resting HR from Garmin/Strava for initial zones. But the zones they give you are based on 220-age \u2014 a formula with \u00B110-20 bpm error.",
    faq_q5: "What is the private beta?",
    faq_a5: "Limited early access. We review each application personally.",
    faq_q6: "What sports does it cover?",
    faq_a6: "Running, cycling, swimming and triathlon. With sport-specific zones.",
    faq_q7: "Is my data secure?",
    faq_a7: "Your data is yours. We don't share anything with third parties.",
...
function LandingInner() {
  ...
  return (
    <div className="lp">
      ...
      {/* ══ 1. HERO — Lactate curve IS the hero ══ */}
              ...
              <div className="lp-showcase__card">
                <div className="lp-showcase__card-visual">
                  <svg viewBox="0 0 200 100" width="100%" preserveAspectRatio="xMidYMid meet">
                    ...
                    <text x="24" y="28" fill="#1a2f38" fontSize="9" fontWeight="700" fontFamily="Space Grotesk">Marat&oacute;n Valencia</text>
                    <text x="24" y="40" fill="#9ca3af" fontSize="7" fontFamily="Space Grotesk">sub 3:15 &middot; 254 d&iacute;as</text>
                    ...
                    <text x="24" y="80" fill="#9ca3af" fontSize="7" fontFamily="Space Grotesk">sub 40:00 &middot; 284 d&iacute;as</text>
      ...
      {/* ══ 7. CTA + FAQ — Combined final section ══ */}
      <section className="lp-section lp-section--dark" id="faq">
        <div className="lp-w">
          ...
          <div className="lp-faq__wrap">
            <p className="lp-ey lp-ey--light">{t("faq_ey")}</p>
            <h2 className="lp-h2 lp-h2--light">{t("faq_h2")}</h2>
            <div className="lp-faq__list">
              {(["1","2","3","4","5","6","7"] as const).map(n => (
                <details key={n} className="lp-faq__item lp-faq__item--dark">
